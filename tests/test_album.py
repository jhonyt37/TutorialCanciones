...
class AlbumTestCase(unittest.TestCase):
    ...
    def test_agregar_album(self):
        ...
        self.coleccion.agregar_album(
            titulo_album1, anio_album1, descripcion_album1, "CD"
        )
        ...
        self.coleccion.agregar_album(
            "Clara luna", anio_album3, descripcion_album3, "CASETE"
        )
        consulta1 = (
            self.session.query(Album).filter(Album.titulo == titulo_album1).first()
        )
    ...
    def test_editar_album(self):
        ...
        self.coleccion.editar_album(
            2, "Clara luna-Mix", 2013, nueva_descripcion_album, "DISCO"
        )
    ...
    def test_dar_album_por_id(self):
        ...
        descripcion_album = self.data_factory.sentence()
        self.coleccion.agregar_album(
            titulo_album, anio_album, descripcion_album, "CASETE"
        )
        album_id = (
