...
class Ventana_Inicial(QWidget):
    ...
    def inicializar_ventana(self):
        ...
        self.distr_caja_busquedas.setAlignment(
            self.etiqueta_resultados, QtCore.Qt.AlignCenter
        )
    ...
    def mostrar_resultados_albumes(self, lista_albums):
        ...
        self.widget_tabla_resultados.layout().setAlignment(
            etiqueta_titulo, QtCore.Qt.AlignTop | QtCore.Qt.AlignHCenter
        )
        ...
        for album in lista_albums:
            ...
            self.widget_tabla_resultados.layout().addWidget(
                etiqueta_nombre, fila, 0, 1, 2
            )
            self.widget_tabla_resultados.layout().setAlignment(
                etiqueta_nombre, QtCore.Qt.AlignTop
            )
    ...
    def mostrar_resultados_canciones(self, lista_canciones):
        ...
        for cancion in lista_canciones:
            ...
            boton_ver.clicked.connect(
                lambda estado, id=cancion["id"]: self.ver_cancion(id)
            )
            boton_ver.setFixedSize(40, 30)
            self.widget_tabla_resultados.layout().addWidget(boton_ver, fila, 1)
            self.widget_tabla_resultados.layout().setAlignment(
    ...
    def mostrar_resultados_interpretes(self, lista_interpretes):
        ...
        self.widget_tabla_resultados.layout().addWidget(
            etiqueta_titulo, 0, 0, 1, 2, QtCore.Qt.AlignCenter
        )
        ...
        for interprete in lista_interpretes:
            ...
            etiqueta_nombre.setFixedSize(200, 30)
            self.widget_tabla_resultados.layout().addWidget(
                etiqueta_nombre, fila, 0, QtCore.Qt.AlignLeft
            )

            boton_ver = QPushButton("Ver canción")
            boton_ver.clicked.connect(
                lambda estado, id=interprete["cancion"]: self.ver_cancion(id)
            )
